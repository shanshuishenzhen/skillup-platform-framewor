...
CREATE INDEX IF NOT EXISTS idx_department_permissions_resource_action ON department_permissions(resource, action);
CREATE INDEX IF NOT EXISTS idx_department_permissions_status ON department_permissions(status);

CREATE INDEX IF NOT EXISTS idx_inheritance_rules_department_id ON permission_inheritance_rules(department_id);
CREATE INDEX IF NOT EXISTS idx_inheritance_rules_resource_action ON permission_inheritance_rules(resource, action);
...
CREATE INDEX IF NOT EXISTS idx_permission_history_target ON permission_change_history(target_type, target_id);
CREATE INDEX IF NOT EXISTS idx_permission_history_changed_at ON permission_change_history(changed_at);
